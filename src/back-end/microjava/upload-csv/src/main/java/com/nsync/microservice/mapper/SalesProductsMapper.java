...
import com.nsync.microservice.entity.SalesOrders;
import com.nsync.microservice.entity.SalesProducts;
...
public class SalesProductsMapper implements CsvEntityMapper<SalesProducts> {
    ...
    public List<String> getRequiredHeaders() {
        return Arrays.asList("sale_order_id", "product_id", "quantity", "unit_price");
    }
}
